...
<div class="sidebar inner">
    <div class="sb_nav">
        ...
        <h3 class='title myCorner' data-corner='top 5px'>{{$matter[0][27]['c_name']}}</h3>
        <div class="active" id="sidebar" data-csnow="2" data-class3="0" data-jsok="2">
            <dl class="list-none navnow"><dt id='part2_4'><a href='#'  title='公司动态' class="zm"><span>{{$matter[0][27]['m_name']}}</span></a></dt></dl>
            <dl class="list-none navnow"><dt id='part2_5'><a href='#'  title='业界资讯' class="zm"><span>{{$matter[0][28]['m_name']}}</span></a></dt></dl>
    ...
    <div class="sb_box">
        <h3 class="title">
            ...
            <span>{{$matter[0][29]['m_name']}}</span>
        </h3>
        <div class="clear"></div>

        <div class="editor active" id="showtext">
            <div><div>
                    <img  src="http://demo.metinfo.cn/upload/images/20120716_133022.gif" style="margin: 8px; width: 150px; float: left; height: 150px" / alt="图片关键词">{!! $matter[0][29]['m_content'] !!}</div>
                <div>
                    &nbsp;</div>
                <div>
                </div>
