        ...
        <!-- 会员注册页面样式 -->
            ...
            <div class="baBody">
                <div class="banneradd bor">
                    ...
                    <div class="baBody">
                        <div class="bbD">
                            &nbsp;&nbsp;&nbsp;&nbsp;栏目：<input type="text" class="input3" id="c_name"/>
                        </div>
                        <div class="bbD">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;权重：<input type="text" class="input3" placeholder="必须为1-100的数字" id="c_weight"/>
                        </div>
                        <div class="bbD">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;链接：<input type="text" class="input3" placeholder="以http开头" id="link"/>
                        </div>
...
<script>
    $(function () {
        $("#btn").click(function () {
            ...
            $.ajax({
                url:"/CloumnAdd",
                data:{c_name:c_name,c_weight:c_weight,link:link,n_id:n_id,whether:whether},
                dataType:"json",
                type:"post",
