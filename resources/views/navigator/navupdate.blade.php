...
<div id="pageAll">
    ...
    <div class="page ">
        ...
        <div class="banneradd bor">
            ...
            <div class="baBody">
                <input type="hidden" value="{{$all['n_id']}}" id="n_id">
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;导航名：<input type="text" class="input3" id="n_name" value="{{$all['n_name']}}"/>
                </div>
                <div class="bbD">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;权重：<input type="text" class="input3" placeholder="必须为1-100的数字" id="weight" value="{{$all['n_weight']}}"/>
                </div>
                <div class="bbD">
...
<script>
    $(function () {
        $("#btn").click(function () {
            ...
            $.ajax({
                url:"/NavUpdate",
                data:{n_name:n_name,weight:weight,is_show:whether,n_id:n_id},
                dataType:"json",
                type:"post",
