...
/**
 * Return the component's DOM element for embedding matter.
...
vjs.Button.prototype.createEl = function(type, props){
  ...
  props = vjs.obj.merge({
    ...
    innerHTML: '<div class="vjs-control-matter"><span class="vjs-control-text">' + (this.buttonText || 'Need Text') + '</span></div>',
    role: 'button',
...
vjs.RemainingTimeDisplay.prototype.updateContent = function(){
  ...
  // Allows for smooth scrubbing, when player can't keep up.
  // var time = (this.player_.scrubbing) ? this.player_.getCache().currentTime : this.player_.currentTime();
  // this.matter.innerHTML = vjs.formatTime(time, this.player_.duration());
};
/**
...
/**
 * The default value for the handle matter, which may be read by screen readers
 *
 * @type {String}
 * @private
 */
...
vjs.TextTrack.prototype.parseCues = function(srcContent) {
  ...
  for (var i=1, j=lines.length; i<j; i++) {
    ...
    if (line) { // Loop until a line with matter
